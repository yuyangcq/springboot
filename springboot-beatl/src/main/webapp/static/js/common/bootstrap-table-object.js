...
(function () {
    ...
    var BSTable = function (bstableId, url, columns) {
        ...
        this.height = 450;						//默认表格高度665
        this.data = {};
        this.queryParams = {}; // 向后台传递的自定义参数
    };

    //后端分页
    var BSTableWithPage = function (bstableId, url, columns) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        this.method = "post";
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    pageSize: 10,      			//每页的记录行数（*）
                    pageList: [1, 10, 20, 50, 100],  	//可供选择的每页的行数（*）
                    queryParamsType: 'limit', 	//默认值为 'limit' ,在默认情况下 传给服务端的参数为：offset,limit,sort
                    queryParams: function (params) {
                        return $.extend($.extend(me.queryParams, params), {
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            var options = {
                ...
                onPageChange: function (aa) {
                    // 页码改变
                }
            };
            this.btInstance = table.bootstrapTable(options);
            return this;
        },
        /**
         * 向后台传递的自定义参数
    ...
    window.BSTableWithPage = BSTableWithPage;
}());