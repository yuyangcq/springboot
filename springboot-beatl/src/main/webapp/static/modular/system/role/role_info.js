...
RolInfoDlg.showDeptSelectTree = function () {
	...
	var deptTree = new $ZTree("deptTree", "/dept/tree/"+appid);
...
RolInfoDlg.showPNameSelectTree = function () {
	...
	if(appid==undefined||appid==''||appid=='0'){
	 ...
	 var pNameTree = new $ZTree("pNameTree", "/role/roleTreeList/"+appid);
...
RolInfoDlg.collectData = function () {
    this.set('id').set('appid').set('name').set('pid').set('deptid').set('tips').set('num');
};
