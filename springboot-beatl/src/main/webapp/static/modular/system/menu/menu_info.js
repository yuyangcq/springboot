...
MenuInfoDlg.collectData = function () {
    this.set('id').set('appid').set('name').set('code').set('pcode').set('url').set('num').set('levels').set('icon').set("ismenu");
}
...
MenuInfoDlg.showMenuSelectTree = function () {
	...
	var ztree = new $ZTree("pcodeTree", "/menu/selectMenuTreeList/"+appid);
